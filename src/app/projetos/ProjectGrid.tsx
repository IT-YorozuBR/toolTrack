...
export function ProjectGrid({ projects, currentPage, totalPages, total, search }: Props) {
              ...
              <div className="flex items-center gap-2 mt-3">
                <span
                  className={`inline-flex items-center px-2 py-0.5 rounded-full text-xs font-medium ${
                    project._count.projectProducts > 0
                      ? "bg-blue-100 text-blue-700"
                      : "bg-yellow-100 text-yellow-700"
                  }`}
                >
                  {project._count.projectProducts}{" "}
                  {project._count.projectProducts === 1 ? "produto" : "produtos"}
                </span>
                {!project.active && (
